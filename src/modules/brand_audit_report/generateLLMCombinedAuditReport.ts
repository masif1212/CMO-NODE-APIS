...
// Use this information to write a short paragraph introducing the brand’s likely purpose, content focus, and target audience based on the available metadata.
// `;

//   promptSections.push(brandIntro);
//   console.log("✅ Intro Prompt:\n", brandIntro);

//   // 🟢 Section 2: PageSpeed / Website Analysis
...
// - Broken Links:
// \`\`\`json
// ${JSON.stringify(page.broken_links || [], null, 2)}
// \`\`\`

// Write a full technical audit analysis of the above metrics. Explain each score’s meaning, its UX and SEO implications, and provide developer-ready recommendations.
// `;
//     promptSections.push(pagespeedPrompt);
//     console.log("📊 PageSpeed Prompt:\n", pagespeedPrompt);
//   }
...
// Write a marketing-level traffic audit:
// - Identify strengths and weaknesses across channels
// - Is bounce rate unusually high?
// - Suggest 2–3 traffic-driving improvements per channel
// - Provide 1 top-priority growth suggestion
// `;
//     promptSections.push(trafficPrompt);
//     console.log("📈 Traffic Prompt:\n", trafficPrompt);
//   }
...
// Write a social media performance review:
// - Highlight most successful platforms
// - Analyze engagement metrics
// - Offer 2–3 actionable strategies to grow reach and conversion
// - Mention recommended post types or frequency improvements
// `;
//     promptSections.push(socialPrompt);
//     console.log("📱 Social Media Prompt:\n", socialPrompt);
//   }

//   if (promptSections.length === 1) {
//     throw new Error("Only metadata found — no analysis data to evaluate.");
//   }
...
//     model: process.env.OPENAI_MODEL || "gpt-4.o",
//     messages: [
...
//   const htmlBody = marked(combinedAudit);
...
//       where: { website_id },
//       update: { brand_audit: fullHtml },
//       create: { website_id, brand_audit: fullHtml },
//     });
//   await prisma.llm_responses.upsert({
//     where: { website_id: website_id },
//     update: { brand_audit: fullHtml },
