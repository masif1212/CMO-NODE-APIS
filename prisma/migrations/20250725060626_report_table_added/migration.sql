...
CREATE TABLE `report` (
    ...
    `dashboard1_rId` LONGTEXT NULL,
    `dashboard2_rId` LONGTEXT NULL,
    `dashboard3_rId` LONGTEXT NULL,
    `dashboard4_rId` LONGTEXT NULL,
    `geo_llm` LONGTEXT NULL,
    `scraped_data_id` VARCHAR(191) NULL,
    `dashboard1_Freedata` LONGTEXT NULL,
    `dashboard_paiddata` LONGTEXT NULL,
    `dashboard1_rdata` LONGTEXT NULL,
    `dashboard2_data` LONGTEXT NULL,
    `dashboard2_rdata` LONGTEXT NULL,
    `dashboard3_data` LONGTEXT NULL,
    `dashboard3_rdata` LONGTEXT NULL,
    `dashboard4_data` LONGTEXT NULL,
    `dashboard4_rdata` LONGTEXT NULL,
